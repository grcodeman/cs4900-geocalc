...
class ClosestPairOfPoints(Algorithms):
    ...
    # This method will return the smallest distance between pairs among all points we have
    ...
    # Given a list of points, find if the min distance is among this list
    ...
    def closestUtil(self, points, sort_x=True):
        ...
        for p in points:
            ...
            if abs(p.coords[0] - midPoint.coords[0]) < d:
                # Add the point to the strip if it's within the distance
                strip.append(p)
